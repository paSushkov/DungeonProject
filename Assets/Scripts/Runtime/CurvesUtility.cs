...
namespace CurvesLines
{
    ...
    public class CurvesUtility : MonoBehaviour
    {
        ...
        public Vector3[] GetOriginalDots
        {
            get => originalDots;
        }

        public Vector3[] GetDotsInuse
        {
            get => dotsInUse;
        }
        ...
        {
            get { return originalDots.Length > dotsInUse.Length ? true : false; }
        }

        public int DesiredDotsNumber
        {
            get => originalDots.Length + 1;
        }
        ...
        public Vector3[] GetDots(Curves.LineTypes Type)
        {
            ...
            switch (Type)
            {
                ...
                {
                    Curves.GetSimpleLineDots(start, end, detail, Noise, ref originalDots);
                    break;
                }
        ...
        {
            if (AutoRebuild || (CutLine && DynamicCutting))
            {
