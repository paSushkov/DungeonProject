...
namespace CurvesLines
{
    ...
    public static class Curves
    {
        ...
        public static void GetSimpleLineDots(Vector3 StartPoint, Vector3 EndPoint, int amount, float Noise, ref Vector3[] result)
        {
            if (result is null || result.Length != amount)
                result = new Vector3[amount];
